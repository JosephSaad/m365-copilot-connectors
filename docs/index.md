...
| [**What is next**](What-is-Next.md) | The three things still open — two work, one decision — with what would close each and which is waiting on a person rather than on effort, plus the fourth, closed as an accepted risk with the record of what was weighed |
