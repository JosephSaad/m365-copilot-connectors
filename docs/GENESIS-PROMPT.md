...
| `SqlTicketsConnector.Security` | Shared secrets, certificates, credentials, SQL, redaction | Class library, referenced by the other three |
...
`SqlTicketsConnector.Security`, referenced by all three executables.
