...
namespace Connector.Security.Configuration
{
    ...
    public sealed class DataSourceOptions
    {
        ...
        /// the row key, for example "https://portal.contoso.com/item/{0}".
        /// </summary>
        // No default: this library is shared by every connector, and a URL that
        // belongs to one of them must not ship as the fallback for the others.
        // Each consumer that needs it validates it for itself.
        ...
        /// <summary>
        /// Gets or sets a value indicating whether the source table carries the IsDeleted
