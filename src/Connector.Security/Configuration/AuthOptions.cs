...
namespace Connector.Security.Configuration
{
    ...
    public sealed class AuthOptions
    {
        ...
        /// <summary>
        /// Gets or sets an optional subject name (for example "CN=sqlconnector.contoso.local").
            ...
            if (this.ParsedMode == AuthMode.ClientSecret)
            {
                ...
                if (LooksLikeASecretValue(this.ClientSecretCredentialTarget))
                {
                    errors.Add(
                        ...
                        "the name of the entry, for example 'SqlConnector/EntraClientSecret'. Store the " +
